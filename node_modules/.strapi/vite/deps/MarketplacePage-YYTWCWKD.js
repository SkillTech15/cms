...
var NpmPackagesFilters = ({ handleSelectClear, handleSelectChange, npmPackageType, possibleCategories, possibleCollections, query }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(c1.Root, {
    children: [
      ...
      (_a = query.collections) == null ? void 0 : _a.map((collection) => (0, import_jsx_runtime.jsx)(R, {
        padding: 1,
        children: (0, import_jsx_runtime.jsx)(f0, {
          icon: (0, import_jsx_runtime.jsx)(C5, {}),
          onClick: () => handleTagRemove(collection, "collections"),
          children: collection
        })
      }, collection)),
      npmPackageType === "plugin" && ((_b = query.categories) == null ? void 0 : _b.map((category) => (0, import_jsx_runtime.jsx)(R, {
        padding: 1,
        children: (0, import_jsx_runtime.jsx)(f0, {
          icon: (0, import_jsx_runtime.jsx)(C5, {}),
...
var FilterSelect = ({ message, value, onChange, possibleFilters, onClear, customizeContent }) => {
  return (0, import_jsx_runtime.jsx)(p0, {
    ...
    children: Object.entries(possibleFilters).map(([filterName, count]) => {
      return (0, import_jsx_runtime.jsx)(Fa, {
          ...
          (0, import_jsx_runtime2.jsx)(R, {
            ...
            children: (0, import_jsx_runtime2.jsx)(I, {
              ...
              children: (0, import_jsx_runtime2.jsxs)(T, {
                ...
                children: [
                  attributes.name,
                  attributes.validated && !attributes.madeByStrapi && (0, import_jsx_runtime2.jsx)(Ar, {
                    description: formatMessage({
                      id: "admin.pages.MarketPlacePage.plugin.tooltip.verified",
                      defaultMessage: "Plugin verified by Strapi"
                    }),
                    children: (0, import_jsx_runtime2.jsx)(a5, {
                      fill: "success600"
                    })
                  }),
                  attributes.madeByStrapi && (0, import_jsx_runtime2.jsx)(Ar, {
  ...
  return (0, import_jsx_runtime2.jsxs)(T, {
    ...
    children: [
      !!githubStars && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
        children: [
          (0, import_jsx_runtime2.jsx)(i1, {
            height: "1.2rem",
            width: "1.2rem",
            "aria-hidden": true
          }),
          (0, import_jsx_runtime2.jsx)(Bn, {
            height: "1.2rem",
            width: "1.2rem",
            fill: "warning500",
            "aria-hidden": true
...
var NpmPackagesGrid = ({ status, npmPackages = [], installedPackageNames = [], useYarn, isInDevelopmentMode, npmPackageType, strapiAppVersion, debouncedSearch }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Um.Root, {
    gap: 4,
    children: npmPackages.map((npmPackage) => (0, import_jsx_runtime3.jsx)(Um.Item, {
      col: 4,
      s: 6,
      xs: 12,
      style: {
...
var PageHeader = ({ isOnline, npmPackageType = "plugin" }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Layouts.Header, {
    ...
    primaryAction: isOnline && (0, import_jsx_runtime4.jsx)(e1, {
...
var OfflineLayout = () => {
  ...
  return (0, import_jsx_runtime5.jsx)(Layouts.Root, {
    children: (0, import_jsx_runtime5.jsxs)(t1, {
      children: [
...
var SortSelect = ({ sortQuery, handleSelectChange }) => {
  ...
  return (0, import_jsx_runtime6.jsx)(SelectWrapper, {
    children: (0, import_jsx_runtime6.jsx)(yo, {
      value: sortQuery,
    ...
    children: (0, import_jsx_runtime7.jsxs)(Page.Main, {
      children: [
        ...
        (0, import_jsx_runtime7.jsx)(Layouts.Content, {
          children: (0, import_jsx_runtime7.jsxs)(S1.Root, {
            variant: "simple",
            ...
            children: [
              (0, import_jsx_runtime7.jsxs)(T, {
                ...
                children: [
                  ...
                  (0, import_jsx_runtime7.jsx)(R, {
                    width: "25%",
                    children: (0, import_jsx_runtime7.jsx)(c0, {
                      name: "searchbar",
                      onClear: () => setQuery({
                        search: "",
                        page: 1
              ...
              (0, import_jsx_runtime7.jsx)(S1.Content, {
                value: PLUGIN,
              ...
              (0, import_jsx_runtime7.jsx)(R, {
                ...
                children: (0, import_jsx_runtime7.jsx)("a", {
                  ...
                  children: (0, import_jsx_runtime7.jsx)(ContentBox, {
                    ...
                    icon: (0, import_jsx_runtime7.jsx)(a1, {}),
                    iconBackground: "alternative100",
                    endAction: (0, import_jsx_runtime7.jsx)(f5, {
                      fill: "neutral600",
                      width: "1.2rem",
                      height: "1.2rem",
                      style: {
...
//# sourceMappingURL=MarketplacePage-YYTWCWKD.js.map
