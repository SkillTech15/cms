  ...
  return (0, import_jsx_runtime.jsxs)(T, {
    ...
    children: [
      (0, import_jsx_runtime.jsx)(yo, {
        ...
        value: pageSize,
        children: options.map((option) => (0, import_jsx_runtime.jsx)(wo, {
          value: option,
          children: option
        }, option))
      }),
...
var Links = ({ boundaryCount = 1, siblingCount = 1 }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(o1, {
    activePage,
    pageCount,
    children: [
      (0, import_jsx_runtime.jsx)(s1, {
        tag: Link,
        to: {
      ...
      items.map((item) => {
        ...
        return (0, import_jsx_runtime.jsx)(h1, {}, item);
      }),
      (0, import_jsx_runtime.jsx)(l1, {
        tag: Link,
        to: {
          search: (0, import_qs.stringify)({
            ...query,
...
//# sourceMappingURL=chunk-FY7OIYQG.js.map
