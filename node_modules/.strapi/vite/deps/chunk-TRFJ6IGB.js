import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-QBJHK6AH.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-7VBNACO7.js";
import {
  LimitsModal
} from "./chunk-WP2ULIV7.js";
import {
...
} from "./chunk-FRL2XIIM.js";
import {
  useTypedSelector
} from "./chunk-SXFTUIKG.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-MTV4I7GH.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-P5LYXSVU.js";
import {
  index
} from "./chunk-LPAYGBXU.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-ATWCYW7B.js";
import {
  useConfig,
  useTracking
} from "./chunk-LTIKO7CZ.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-SXSPE63K.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-HUHQ4WAQ.js";
import {
  renderAdmin
} from "./chunk-T647B3YO.js";
import {
  useAIAvailability
} from "./chunk-RY6YF63Q.js";
import {
  useLicenseLimits
} from "./chunk-UCUWI74B.js";
import {
  Table,
  useTable
} from "./chunk-UZGJNVDT.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-EFJN642Y.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-ITEXD3VJ.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-V7BQEK34.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-V6IUHEMY.js");
        return {
...
var AITranslationStatusAction = ({ documentId, model, collectionType }) => {
  ...
  return {
    _status: {
      message: (0, import_jsx_runtime18.jsx)(R, {
        height: "100%",
        "aria-label": formatMessage({
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-UACNL4BL.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-WAA6AFRU.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-62NWGTMW.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-MPIUXZB6.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-AKXK3I7U.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-75VOO4X4.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-5XMXLQX3.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-MUPLZPT6.js");
          return {
...
//# sourceMappingURL=chunk-TRFJ6IGB.js.map
